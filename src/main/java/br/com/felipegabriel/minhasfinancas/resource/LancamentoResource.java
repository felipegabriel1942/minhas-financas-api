...
import br.com.felipegabriel.minhasfinancas.dto.AtualizaStatusDTO;
import br.com.felipegabriel.minhasfinancas.dto.LancamentoDTO;
...
public class LancamentoResource {
	...
	public ResponseEntity<?> atualizar(@PathVariable("id") Long id, @RequestBody LancamentoDTO dto) {
		...
		}).orElseGet(() -> new ResponseEntity("Lançamento não encontado na base de dados.", HttpStatus.BAD_REQUEST));
	}
